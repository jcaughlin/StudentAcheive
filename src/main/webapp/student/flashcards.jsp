                        ...
                        <div class="card-body">
                            <h3 class="card-title">
                                ...
                                <div class="form-check pb-2">
                                    <input type="radio" class="form-check-input" name="quiz-response" value="firstResponse"id="firstResponse">
                                    <label for="firstResponse" class="form-check-label">A. Bob</label>
                                </div>
                                <div class="form-check pb-2">
                                    <input type="radio" class="form-check-input" name="quiz-response" value="secondResponse" id="secondResponse">
                                    <label for="secondResponse" class="form-check-label">B. Ralph</label>
                                </div>
                                <div class="form-check pb-2">
                                    <input type="radio" class="form-check-input" name="quiz-response" value="thirdResponse" id="thirdResponse">
                                    <label for="thirdResponse"class="form-check-label">C. Fred</label>
                                </div>
                                <div class="form-check pb-2">
                                    <input type="radio" class="form-check-input" name="quiz-response" value="forthResponse" id="forthResponse">
                                    <label for"forthResponse" class="form-check-label">D. Ernesto</label>
                                </div>
                                <div class="pb-2">
                                </div><button class="btn btn-success" type="submit">GO!</button>
                        </div>
                        </form>
